...
function getMockWalletAddress() {
  ...
  function loadPlayerData() {
    ...
    console.log(`Wallet: ${wallet}, Total Rewards: ${totalRewards} tokens`);
  ...
  function mockContractCall() {
    ...
    // Simulate a contract function like "claim reward"
    setTimeout(() => {
